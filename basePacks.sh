...
pacman -S grub xorg efibootmgr networkmanager network-manager-applet dialog wpa_supplicant mtools dosfstools reflector base-devel linux-headers nvidia nvidia-utils nvidia-settings openssh openvpn rofi xorg-xinit base-devel cmake unzip ninja tree-sitter curl nodejs-lts-fermium zsh stow ranger okular highlight pygmentize python-pygments xdg-utils npm xsel python-pyx python-pip wget ripgrep fd luarocks go go-tools discord pipewire pipewire-pulse pipewire-alsa
